...
/**
  ...
  */
abstract class LagompbCommandHandler[TState <: scalapb.GeneratedMessage](
  ...
  /**
    ...
    */
  def handle(command: LagompbCommand,
             currentState: TState,
...
/**
  ...
  * @tparam TState the aggregate state type
  */
abstract class LagompbEventHandler[TState <: scalapb.GeneratedMessage](
  actorSystem: ActorSystem
) {
