...
/**
  ...
  */
final class InternalServerError(errorCode: TransportErrorCode,
...
object InternalServerError {
  ...
  def apply(message: String) = new InternalServerError(
    ErrorCode,
...
/**
  ...
  * @param message the exception message
  */
final class LagompbInvalidCommandException(message: String)
