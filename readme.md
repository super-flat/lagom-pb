...
[![Build Status](https://www.travis-ci.com/super-flat/lagom-pb.svg?branch=master)](https://www.travis-ci.com/super-flat/lagom-pb)
...
Scala Developer velocity in [lagom](https://www.lagomframework.com/documentation/1.6.x/scala/Home.html) development
...
- Implementation of an HTTP/Json based microservice using REST interfaces by defining _**api requests and responses as
  protobuf messages**_.
...
There is a demo application built on top the library that can be found
here [Sample](https://github.com/super-flat/lagom-pb-sample)
